...
namespace Loja.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarroId,Modelo,Marca,Ano,Preco,IsNovo,Estoque")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarroId,Modelo,Marca,Ano,Preco,IsNovo,Estoque")] Carro carro)
        {
            if (id != carro.CarroId)
            {
                return NotFound();
